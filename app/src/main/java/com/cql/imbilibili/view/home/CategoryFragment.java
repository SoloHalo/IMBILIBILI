package com.cql.imbilibili.view.home;
...
import com.cql.imbilibili.view.adapter.partion.GridViewAdapter;
import com.cql.imbilibili.view.adapter.partion.model.PartionModel;
import com.cql.imbilibili.view.partion.PartitionActivity;

import butterknife.BindView;
import butterknife.ButterKnife;

/**
 * Created by CQL on 2016/9/29.
 * 分区界面
 */
    ...
    public void onItemClick(int position) {
        ...
        switch (position) {
            ...
            case 9://鬼畜
                builder.setName("时尚")
                        .setId(155)
                        .addSubPartion("美妆", R.mipmap.ic_category_t157, 157)
                        .addSubPartion("服饰", R.mipmap.ic_category_t158, 158)
                        .addSubPartion("资讯", R.mipmap.ic_category_t159, 159)
                        .addSubPartion("健身", R.mipmap.ic_category_t164, 164);
                break;
            case 11:
                builder.setName("娱乐")
                        .setId(5)
                        .addSubPartion("综艺",R.mipmap.ic_category_t71,71)
                        .addSubPartion("明星",R.mipmap.ic_category_t137,137)
                        .addSubPartion("KOREA相关",R.mipmap.ic_category_t131,131);
                break;
            case 12:
                builder.setName("电影")
                        .setId(23)
                        .addSubPartion("电影相关", R.mipmap.ic_category_t82, 82)
                        .addSubPartion("短片", R.mipmap.ic_category_t85, 85)
                        .addSubPartion("欧美电影", R.mipmap.ic_category_t145, 145)
                        .addSubPartion("日本电影", R.mipmap.ic_category_t146, 146)
                        .addSubPartion("国产电影",R.mipmap.ic_category_t147,147)
                        .addSubPartion("其他国家",R.mipmap.ic_category_t83,83);
                break;
            case 13:
                builder.setName("电视剧")
                        .setId(11)
                        .addSubPartion("连载剧集", R.mipmap.ic_category_t15, 15)
                        .addSubPartion("完结剧集", R.mipmap.ic_category_t34, 34)
                        .addSubPartion("特摄.布袋戏", R.mipmap.ic_category_t86, 86)
                        .addSubPartion("电视剧相关", R.mipmap.ic_category_t128, 128);
                break;
            default:
                return;
        }
