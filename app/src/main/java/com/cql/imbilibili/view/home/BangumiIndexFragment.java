...
import com.cql.imbilibili.view.adapter.bangumiindex.BangumiIndexAdapter;
import com.cql.imbilibili.view.adapter.bangumiindex.GridMenuAdapter;
                ...
                .subscribeWith(new DisposableSingleObserver<BangumiIndex>() {
                    ...
                    public void onSuccess(BangumiIndex bangumiIndex) {
                        ...
                        if (mBangumiIndex.getPages().equals(mCurrentPage + "") || mBangumiIndex.getList().size() == 0) {
                            ...
                            mLoadMoreRecyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_NO_MORE);
                        } else {
                            mLoadMoreRecyclerView.setEnableLoadMore(true);
                            mLoadMoreRecyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_REFRESHING);
                        }
                    }
