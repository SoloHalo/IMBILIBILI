package com.cql.imbilibili.view.feedback;
...
import com.cql.imbilibili.model.feedback.FeedbackData;
import com.cql.imbilibili.model.feedback.ReplyCount;
...
import com.cql.imbilibili.view.adapter.feedback.FeedbackAdapter;
import com.cql.imbilibili.view.adapter.feedback.FeedbackItemDecoration;
import com.cql.imbilibili.view.bangumi.EpisodeDialogFragment;
        ...
        CommonHelper.getInstance()
                ...
                .subscribeWith(new DisposableSingleObserver<FeedbackData>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        mRecyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_RETRY);
                    }
                });
    }
