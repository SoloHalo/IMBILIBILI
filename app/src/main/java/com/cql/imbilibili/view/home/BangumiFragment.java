...
import com.cql.imbilibili.view.bangumi.BangumiTagActivity;
import com.cql.imbilibili.view.bangumi.BangumiTimeTableActivity;
...
import com.cql.imbilibili.view.LazyLoadFragment;
import com.cql.imbilibili.view.adapter.bangumi.BangumiAdapter;
import com.cql.imbilibili.view.adapter.bangumi.BangumiIndexItemDecoration;
import com.cql.imbilibili.view.bangumi.BangumiDetailActivity;
import com.cql.imbilibili.view.bangumi.FollowBangumiActivity;
import com.cql.imbilibili.view.bangumi.SeasonGroupActivity;
import com.cql.imbilibili.view.common.WebViewActivity;
...
public class BangumiFragment extends LazyLoadFragment implements SwipeRefreshLayout.OnRefreshListener, LoadMoreRecyclerView.OnLoadMoreLinstener, BangumiAdapter.OnItemClickListener {
        ...
        mAllDataSub = Observable.mergeDelayError(loadIndexData(), loadBangumiRecommendData(mCursor, PAGE_SIZE))
                ...
                .subscribeWith(new DisposableCompletableObserver(){
                    ...
                    public void onError(Throwable e) {
                        finishTask();
                        recyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_FAIL);
                ...
                .subscribeWith(new DisposableSingleObserver<List<IndexBangumiRecommend>>(){
                    ...
                    public void onSuccess(List<IndexBangumiRecommend> indexBangumiRecommends) {
                        ...
                        if (indexBangumiRecommends.size() == 0) {
                            recyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_NO_MORE);
                            recyclerView.setEnableLoadMore(false);
                        } else {
    ...
    public void onClick(int itemType, String data) {
        if (itemType == BangumiAdapter.SERIALIZING_GRID_ITEM) {
            ...
            }else if (data.equals(String.valueOf(R.id.table))){
                BangumiTimeTableActivity.startActivity(getContext());
            }else if (data.equals(String.valueOf(R.id.index))){
                BangumiTagActivity.startActivity(getContext());
            }
        }
    }
