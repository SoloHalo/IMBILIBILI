...
import com.cql.imbilibili.data.helper.LoginHelper;
...
import com.cql.imbilibili.utils.BiliBilliSignUtils;
import com.cql.imbilibili.utils.DisposableUtils;
import com.cql.imbilibili.utils.DrawableTintUtils;
import com.cql.imbilibili.utils.RsaHelper;
                            ...
                            if (isFirst) {
                                ...
                                if (entry.getKey().equals("password")) {
                                    ...
                                    bodyBuilder.append("&")
                                            .append(entry.getKey())
                                            .append("=")
                                            .append(URLEncoder.encode(entry.getValue(), "utf-8"));//编码
                                } else {
                                    bodyBuilder.append("&")
                                            .append(entry.getKey())
                                            .append("=")
