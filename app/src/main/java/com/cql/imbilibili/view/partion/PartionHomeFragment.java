package com.cql.imbilibili.view.partion;
...
import com.cql.imbilibili.model.partion.PartionHome;
import com.cql.imbilibili.model.partion.PartionVideo;
...
import com.cql.imbilibili.view.adapter.partion.PartionHomeRecyclerViewAdapter;
import com.cql.imbilibili.view.adapter.partion.PartionItemDecoration;
...
//        mNeedForeRefresh = false;
        ...
        mPartionAllDataSub = Observable.mergeDelayError(CommonHelper.getInstance()
                ...
                .subscribeWith(new DisposableCompletableObserver(){
                    ...
                    public void onError(Throwable e) {
                        finishTask();
                        mRecyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_FAIL);
    ...
    public void onRefresh() {
        mCurrentPage = 1;
        mRecyclerView.setEnableLoadMore(true);
        mRecyclerView.setLoadingViewState(LoadMoreRecyclerView.STATE_REFRESHING);
